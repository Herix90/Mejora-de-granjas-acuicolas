...
# Texto de salida
text_output = Text(output_frame, width=200, height=30)  # Ajusta el ancho y la altura según tus necesidades
text_output.pack(side=LEFT, fill=Y)  # Agrega barras de desplazamiento vertical
